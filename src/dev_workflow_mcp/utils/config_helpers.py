...
def get_server_configuration() -> Optional[Union[ServerConfig, ServerConfiguration]]:
...
def get_workflow_directory_path() -> Optional[Path]:
...
def get_sessions_directory_path() -> Optional[Path]:
...
def get_cache_directory_path() -> Optional[Path]:
